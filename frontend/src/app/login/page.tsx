    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">Sign in to your accounting dashboard</p>
        </div>
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          ...
          <p className="text-sm text-center text-gray-500 dark:text-gray-400">
            No account?{" "}
            <Link href="/register" className="text-primary-600 font-medium hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
              Register
            </Link>
          </p>
        </form>
